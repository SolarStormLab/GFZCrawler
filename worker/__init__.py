...
pattern = {
	...
	'kp': r"^(?P<year>\d{4})\s+(?P<month>\d{2})\s+(?P<day>\d{2})\s+(?P<days>\d{5}\.\d{5})\s+(?P<days_m>\d{5}\.\d{5})\s+(?P<bsr>-?\d{4})\s+(?P<db>-?\d{,2})\s+(?P<kp1>-?\d{,2}.\d{,3})\s+(?P<kp2>-?\d{,2}.\d{,3})\s+(?P<kp3>-?\d{,2}.\d{,3})\s+(?P<kp4>-?\d{,2}.\d{,3})\s+(?P<kp5>-?\d{,2}.\d{,3})\s+(?P<kp6>-?\d{,2}.\d{,3})\s+(?P<kp7>-?\d{,2}.\d{,3})\s+(?P<kp8>-?\d{,2}.\d{,3})\s+(?P<ap1>-?\d{,4})\s+(?P<ap2>-?\d{,4})\s+(?P<ap3>-?\d{,4})\s+(?P<ap4>-?\d{,4})\s+(?P<ap5>-?\d{,4})\s+(?P<ap6>-?\d{,4})\s+(?P<ap7>-?\d{,4})\s+(?P<ap8>-?\d{,4})\s+(?P<ap>-?\d{,4})\s+(?P<sn>-?\d{,3})\s+(?P<f107obs>-?\d{,6}\.\d{1})\s+(?P<f107adj>-?\d{,6}\.\d{1})\s+(?P<d>-?\d{1})$"
}
